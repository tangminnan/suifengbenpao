package com.runwithwind.framework.shiro.web.filter.online;
            ...
            throws Exception
    {
        ...
        if (session != null && session instanceof OnlineSession)
        {
            ...
            if (isGuest == true)
            {
                ...
                if (user != null)
                {
                    onlineSession.setUserId(Long.parseLong(user.getId().toString()));
                    onlineSession.setLoginName(user.getPhone());
