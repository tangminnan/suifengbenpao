...
import com.runwithwind.framework.aspectj.lang.enums.BusinessStatus;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.runwithwind.framework.aspectj.lang.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult)
    {
        try
        {
            ...
            // 获取当前的用户
            RunUser currentUser = ShiroUtils.getSysUser();
