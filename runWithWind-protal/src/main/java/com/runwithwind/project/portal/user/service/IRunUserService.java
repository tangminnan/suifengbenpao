package com.runwithwind.project.portal.user.service;
...
public interface IRunUserService {
  ...
  RunUser selectRunUserByPhone(String username);

  boolean exit(RunUser user);

  RunUser selectRunUserByOpenId(String openId);
}
