package com.runwithwind.project.portal.record.mapper;
 ...
 * @date 2020-12-22
 */
public interface RunCourseRecordMapper 
{
    /**
     * 查询课程记录
     * 
    ...
    RunCourseRecord selectRunCourseRecordByPadMac(String macId);

    List<RunCourseRecord> getCourseByUserId(Integer userId);
}
