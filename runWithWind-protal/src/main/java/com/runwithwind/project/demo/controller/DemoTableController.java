...
import com.runwithwind.framework.web.page.PageDomain;
import com.runwithwind.framework.web.page.TableDataInfo;
import com.runwithwind.framework.web.page.TableSupport;
...
public class DemoTableController extends BaseController
{
     ...
     * 搜索相关
     */
    @RequiresPermissions("demo:table:search")
    @GetMapping("/search")
     ...
     * 数据汇总
     */
    @RequiresPermissions("demo:table:footer")
    @GetMapping("/footer")
     ...
     * 组合表头
     */
    @RequiresPermissions("demo:table:groupHeader")
     ...
     * 表格导出
     */
    @RequiresPermissions("demo:table:export")
    @GetMapping("/export")
     ...
     * 翻页记住选择
     */
    @RequiresPermissions("demo:table:remember")
    @GetMapping("/remember")
     ...
     * 跳转至指定页
     */
    @RequiresPermissions("demo:table:pageGo")
    @GetMapping("/pageGo")
     ...
     * 自定义查询参数
     */
    @RequiresPermissions("demo:table:params")
    @GetMapping("/params")
     ...
     * 多表格
     */
    @RequiresPermissions("demo:table:multi")
    @GetMapping("/multi")
    public String multi()
    {
        return prefix + "/multi";
     ...
     * 点击按钮加载表格
     */
    @RequiresPermissions("demo:table:button")
    @GetMapping("/button")
     ...
     * 直接加载表格数据
     */
    @RequiresPermissions("demo:table:data")
    @GetMapping("/data")
     ...
     * 表格冻结列
     */
    @RequiresPermissions("demo:table:fixedColumns")
     ...
     * 自定义触发事件
     */
    @RequiresPermissions("demo:table:event")
    @GetMapping("/event")
    public String event()
    {
        return prefix + "/event";
     ...
     * 表格细节视图
     */
    @RequiresPermissions("demo:table:detail")
    @GetMapping("/detail")
     ...
     * 表格父子视图
     */
    @RequiresPermissions("demo:table:child")
    @GetMapping("/child")
    public String child()
    {
        return prefix + "/child";
     ...
     * 表格图片预览
     */
    @RequiresPermissions("demo:table:image")
    @GetMapping("/image")
    public String image()
    {
        return prefix + "/image";
     ...
     * 动态增删改查
     */
    @RequiresPermissions("demo:table:curd")
    @GetMapping("/curd")
    public String curd()
    {
        return prefix + "/curd";
     ...
     * 表格拖拽操作
     */
    @RequiresPermissions("demo:table:reorder")
    @GetMapping("/reorder")
     ...
     * 表格列宽拖动
     */
    @RequiresPermissions("demo:table:resizable")
     ...
     * 表格行内编辑操作
     */
    @RequiresPermissions("demo:table:editable")
    @GetMapping("/editable")
     ...
     * 主子表提交
     */
    @RequiresPermissions("demo:table:subdata")
    @GetMapping("/subdata")
     ...
     * 表格自动刷新
     */
    @RequiresPermissions("demo:table:refresh")
    @GetMapping("/refresh")
     ...
     * 表格打印配置
     */
    @RequiresPermissions("demo:table:print")
    @GetMapping("/print")
    public String print()
    {
        return prefix + "/print";
     ...
     * 表格标题格式化
     */
    @RequiresPermissions("demo:table:headerStyle")
     ...
     * 表格其他操作
     */
    @RequiresPermissions("demo:table:other")
    @GetMapping("/other")
    public String other()
    {
        return prefix + "/other";
