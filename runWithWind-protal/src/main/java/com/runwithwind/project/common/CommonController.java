package com.runwithwind.project.common;
...
import com.runwithwind.framework.config.ServerConfig;
...
public class CommonController
{
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
            ...
            String filePath = runwithwindConfig.getDownloadPath() + fileName;
    ...
    {
        // 本地资源路径
        String localPath = runwithwindConfig.getProfile();
        // 数据库资源地址
