package com.runwithwind.project.tool.gen.controller;
...
import com.runwithwind.project.tool.gen.service.IGenTableColumnService;
import com.runwithwind.project.tool.gen.service.IGenTableService;
...
public class GenController extends BaseController
{
   ...
   // @RequiresPermissions("tool:gen:view")
    ...
    {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"runwithwind.zip\"");
