...
import com.runwithwind.framework.web.domain.CxSelect;
...
public class DemoFormController
{
     ...
     * 按钮页
     */
    @RequiresPermissions("monitor:form:button")
    @GetMapping("/button")
     ...
     * 下拉框
     */
    @RequiresPermissions("monitor:form:select")
    @GetMapping("/select")
     ...
     * 时间轴
     */
    @RequiresPermissions("monitor:form:timeline")
    @GetMapping("/timeline")
     ...
     * 表单校验
     */
    @RequiresPermissions("monitor:form:validate")
    @GetMapping("/validate")
     ...
     * 功能扩展（包含文件上传）
     */
    @RequiresPermissions("monitor:form:jasny")
    @GetMapping("/jasny")
    public String jasny()
    {
        return prefix + "/jasny";
     ...
     * 拖动排序
     */
    @RequiresPermissions("monitor:form:sortable")
    @GetMapping("/sortable")
     ...
     * 选项卡 & 面板
     */
    @RequiresPermissions("monitor:form:tabsPanels")
     ...
     * 栅格
     */
    @RequiresPermissions("monitor:form:grid")
    @GetMapping("/grid")
    public String grid()
    {
        return prefix + "/grid";
     ...
     * 表单向导
     */
    @RequiresPermissions("monitor:form:wizard")
    @GetMapping("/wizard")
     ...
     * 文件上传
     */
    @RequiresPermissions("monitor:form:upload")
    @GetMapping("/upload")
     ...
     * 左右互选组件
     */
    @RequiresPermissions("monitor:form:duallistbox")
     ...
     * 基本表单
     */
    @RequiresPermissions("monitor:form:basic")
    @GetMapping("/basic")
    public String basic()
    {
        return prefix + "/basic";
     ...
     * 卡片列表
     */
    @RequiresPermissions("monitor:form:cards")
    @GetMapping("/cards")
    public String cards()
    {
        return prefix + "/cards";
     ...
     * summernote 富文本编辑器
     */
    @RequiresPermissions("monitor:form:summernote")
     ...
     * 搜索自动补全
     */
    @RequiresPermissions("monitor:form:autocomplete")
     ...
     * 多级联动下拉
     */
    @RequiresPermissions("monitor:form:cxselect")
    @GetMapping("/cxselect")
     ...
     * 局部刷新
     */
    @RequiresPermissions("monitor:form:localrefresh")
     ...
     * @param taskName 任务名称
     */
    @RequiresPermissions("monitor:form:task")
     ...
     * 模拟数据
     */
    @RequiresPermissions("monitor:form:cityData")
    @GetMapping("/cityData")
    @ResponseBody
     ...
     * 获取用户数据
     */
    @RequiresPermissions("monitor:form:userModel")
     ...
     * 获取数据集合
     */
    @RequiresPermissions("monitor:form:collection")
    @GetMapping("/collection")
    @ResponseBody
    public AjaxResult collection()
    {
        String[] array = { "runwithwind 1", "runwithwind 2", "runwithwind 3", "runwithwind 4", "runwithwind 5" };
        AjaxResult ajax = new AjaxResult();
