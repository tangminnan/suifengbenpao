...
import com.runwithwind.common.utils.CookieUtils;
...
import com.runwithwind.project.system.menu.domain.Menu;
import com.runwithwind.project.system.menu.service.IMenuService;
...
public class IndexController extends BaseController {
	...
	@Autowired
	private runwithwindConfig runWithWindConfig;
	...
	public String index(ModelMap mmap) {
		...
		mmap.put("copyrightYear", runWithWindConfig.getCopyrightYear());
		mmap.put("demoEnabled", runWithWindConfig.isDemoEnabled());
	...
	public String main(ModelMap mmap) {
		mmap.put("version", runWithWindConfig.getVersion());
		return "main";
	}
}
